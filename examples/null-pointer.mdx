...
**Debug** traces the full execution path through the [context graph](/concepts/context-engine) from the point of failure back to the source, identifies exactly where the null value enters without a guard, and returns a targeted fix.

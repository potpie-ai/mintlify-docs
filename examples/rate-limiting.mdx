...
**Build** reads the full routing structure through the [context graph](/concepts/context-engine), identifies every entry point that needs a limit, and generates a **specification** covering every file to create or modify before writing a line.

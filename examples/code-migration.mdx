...
**Build** reads the existing module through the [context graph](/concepts/context-engine), maps every dependent service and interface, and generates a **specification** listing every file to create or modify before a line of code is written.

...
**Ask** traces the full **authentication flow** through the [context graph](/concepts/context-engine), from incoming request to token validation to access enforcement, and returns every file involved with exact line ranges.

...
Custom agents access 60+ specialized tools across six categories: Knowledge Graph, Code Access, External, Project Management, Integration, and Code Changes.
...
graph LR
    ...
    A --> C[Code Access Tools]
    A --> D[External Tools]
    A --> E[Project Management Tools]
    A --> F[Integration Tools]
    A --> G[Code Changes Tools]

    style A fill:#b3f5d1,stroke:#333,color:#000
    style B fill:#e8f4f8,stroke:#333,color:#000
    style C fill:#f0f0f0,stroke:#333,color:#000
    style D fill:#bfe3ff,stroke:#333,color:#000
    style E fill:#ffc9c9,stroke:#333,color:#000
    style F fill:#fff4e1,stroke:#333,color:#000
    style G fill:#f4e8f8,stroke:#333,color:#000
```
...
Tools for tracking multi-step operations, managing requirements, and coordinating agent workflows.
...
| Making code changes | Code Changes tools (`add_file_to_changes`, `update_file_lines`, etc.) |
| Tracking progress | Project Management tools (`create_todo`, `update_todo_status`, etc.) |
| External integrations | Integration tools (GitHub, Jira, Linear, Confluence) |
| Research & documentation | External tools (`web_search_tool`, `webpage_extractor`) |
...
**Integration Agents:**
- Integration tools (Jira, Linear, Confluence, GitHub)
- Project Management tools

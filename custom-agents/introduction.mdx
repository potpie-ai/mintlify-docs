...
Custom agents access the same tools as system agents:

<CardGroup cols={3}>
  <Card title="Knowledge Graph Tools" icon="sitemap">
    **19 tools**
  ...
  <Card title="Code Analysis Tools" icon="file-code">
    **12 tools**
...
<Tip>
  Tools execute within the agent's context and feed results back for decision-making. See the [Tools Reference](/agents/tools-reference) for complete details.
</Tip>

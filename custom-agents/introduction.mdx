...
2. **Tools:** An array of tool IDs the agent can use. Each task requires at least one tool, selected from the <a href="/agents/tools-reference" className="mode-link">library of 60+ options</a>.

...
```mermaid
graph LR
    A["Understand\n& Validate"] --> B["Explore &\nHypothesize"] --> C["Identify\nRoot Cause"] --> D["Generalize\nthe Issue"] --> E["Design\nSolution"] --> F["Scrutinize\n& Refine"] --> G["Implement"] --> H["Final\nVerification"]
...
- [Code Agent](/agents/code-changes-agent) - Generates and manages code modifications

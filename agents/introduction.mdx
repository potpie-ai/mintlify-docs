...
<CardGroup cols={3}>
  <Card title="Ask a Question" icon="book-open" href="/build-flow/ask-a-question">
    Use the Ask Agent for exploration and comprehension
  </Card>
  <Card title="Build a Feature" icon="pen-to-square" href="/build-flow/build-a-feature">
    Use the Code Agent for changes and features
  </Card>
  <Card title="Debug an Issue" icon="wrench" href="/build-flow/debug-an-issue">

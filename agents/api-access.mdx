...
Parsing builds the [context graph](/concepts/context-engine) for your repository. Every subsequent API call like creating conversations, sending messages requires a `project_id` from this step.

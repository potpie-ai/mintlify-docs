...
| `linear-team ingest TEAM` | One-shot Linear team ingestion into the active pot. |
| `linear-team diff-sync TEAM` | Incremental Linear team graph diff-sync. |
| `jira-project ingest PROJECT` | One-shot Jira project ingestion into the active pot. |

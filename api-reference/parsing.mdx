...
Once parsing is complete (`status: "ready"`), you can:

1. [Create conversations](/api-reference/endpoint/create-conversation) with the project
2. Use agents to analyze the codebase
3. [Search the codebase](/api-reference/endpoint/search-codebase) semantically

...
<Card title="Get Parsing Status By Repo" icon="code-branch" href="/api-reference/endpoint/get-parsing-status-by-repo">
  Retrieve parsing status by providing repository details instead of project ID.
</Card>

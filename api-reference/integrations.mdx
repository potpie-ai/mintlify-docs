...
```bash cURL
curl -X POST https://localhost:8001/api/v2/integrations/save \
...
def save_integration(
    ...
    url = "https://localhost:8001/api/v2/integrations/save"
...
async function saveIntegration(
  ...
  const response = await fetch(
    'https://localhost:8001/api/v2/integrations/save',
    {
      method: 'POST',
      headers: {
        'x-api-key': apiKey,

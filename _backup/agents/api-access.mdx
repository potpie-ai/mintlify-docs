...
2. Click on your username in the bottom left corner and select **Settings**.

<img src="/images/api-key-username-menu.png" alt="Username menu with Key Management option" />

3. In **Settings**, find the **Your API Key** section and click **+ Generate API Key**.

<img src="/images/api-key-management-page.png" alt="API Key Management page" />

4. Redacted API Key is Generated.

<img src="/images/api-key-generated.png" alt="Generated API Key displayed in Settings" />

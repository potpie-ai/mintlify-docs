...
Logfire provides observability and tracing for AI calls made by Potpie.

Create a free account at [Logfire](https://logfire.pydantic.dev/) and add the following to `.env`:

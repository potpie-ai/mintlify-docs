...
| Tool | Description |
|------|-------------|
| <a href="/agents/tools-reference#linear-issue-fetcher" className="mode-link">Issue Fetcher</a> | Fetch issue details |
| <a href="/agents/tools-reference#linear-issue-updater" className="mode-link">Issue Updater</a> | Update issue fields |

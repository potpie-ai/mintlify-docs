...
- A <a href="https://app.potpie.ai" className="mode-link">Potpie account</a>
...
| Tool | Description |
|------|-------------|
| <a href="/agents/tools-reference#github-issue-fetcher" className="mode-link">Issue Fetcher</a> | Fetch issues and pull requests |
| <a href="/agents/tools-reference#github-file-reader" className="mode-link">File Reader</a> | Read file contents |
| <a href="/agents/tools-reference#github-branch-creator" className="mode-link">Branch Creator</a> | Create branches |
| <a href="/agents/tools-reference#github-file-committer" className="mode-link">File Committer</a> | Modify and commit files |
| <a href="/agents/tools-reference#github-pr-creator" className="mode-link">PR Creator</a> | Create pull requests |
| <a href="/agents/tools-reference#github-pr-commenter" className="mode-link">PR Commenter</a> | Add PR comments |

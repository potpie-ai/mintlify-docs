...
| Tool | Description |
|------|-------------|
| <a href="/agents/tools-reference#confluence-space-lister" className="mode-link">Space Lister</a> | List all spaces |
| <a href="/agents/tools-reference#confluence-page-fetcher" className="mode-link">Page Fetcher</a> | Fetch a page by ID |
| <a href="/agents/tools-reference#confluence-space-pages" className="mode-link">Space Pages</a> | List pages in a space |
| <a href="/agents/tools-reference#confluence-page-search" className="mode-link">Page Search</a> | Search using CQL |
| <a href="/agents/tools-reference#confluence-page-creator" className="mode-link">Page Creator</a> | Create a new page |
| <a href="/agents/tools-reference#confluence-page-updater" className="mode-link">Page Updater</a> | Update an existing page |
| <a href="/agents/tools-reference#confluence-comment-writer" className="mode-link">Comment Writer</a> | Add a comment to a page |

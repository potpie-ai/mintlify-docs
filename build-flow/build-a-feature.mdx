...
Potpie reads existing patterns, conventions, and dependencies from the [context graph](/concepts/context-engine) before initiating a line of code.
...
<CardGroup cols={2}>
  ...
  <Card title="Code Migration" href="/examples/code-migration">
    Migrating a module with full dependency mapping before touching a line.
  </Card>
</CardGroup>

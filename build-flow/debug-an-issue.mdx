...
When a reported issue is received, it traverses the <a href="/concepts/knowledge-graph" className="mode-link">knowledge graph</a> across every affected component to determine the true origin of the problem.
...
If you intend to trace an issue to its origin across the knowledge graph and get a fix at the source rather than a symptom patch, follow the <a href="/tutorials/trace-and-fix" className="mode-link">Trace and Fix Bugs tutorial</a>.

...
For local workflows, start with the [CLI Overview](/cli/reference), parse the repository, and then inspect the relevant graph slice before debugging through it.

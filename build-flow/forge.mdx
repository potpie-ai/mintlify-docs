...
**Forge** is Potpie's **structured code generation** environment. Engineers define the desired outcome, constraints, and system boundaries before generation begins. Forge translates those specifications into implementation with full awareness of what already exists in the repository.

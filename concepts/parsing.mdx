...
<Steps>
  ...
  <Step title="Scoring">
    **PageRank** scores each node by how frequently other nodes reference it. These scored nodes then pass to <a href="/concepts/inference" className="mode-link">inference</a>, which gives each one a semantic meaning.
  </Step>
</Steps>

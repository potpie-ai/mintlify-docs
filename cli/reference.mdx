...
<Note>
New to Potpie? Start with [Introduction](/cli/introduction) and [Installation](/cli/installation) before diving into the reference.
</Note>

## Command Families

<CardGroup cols={2}>
  <Card title="CLI Manual" icon="terminal" href="/cli/manual">
